...
class Algo:
    ...
    def check_north_max(whole_map, ship_coordinates, ship_speed, ship_size, directions_weights):
        ...
        north_free = Algo.check_north(whole_map, ship_coordinates, ship_speed * 2 + ship_size)
        east_free = Algo.check_east(whole_map, ship_coordinates, ship_speed // 2 + ship_size)
        west_free = Algo.check_west(whole_map, ship_coordinates, ship_speed // 2 + ship_size)
        ...
        if north_free*directions_weights[0]==max_points:
            ...
            direction_degrees = -90
            ship_speed //= 2
        ship_speed = ship_speed % 10 + ship_speed // 10 * 10
    ...
    def check_east_max(whole_map, ship_coordinates, ship_speed, ship_size, directions_weights):
        ...
        east_free = Algo.check_east(whole_map, ship_coordinates, ship_speed * 2 + ship_size)
        north_free = Algo.check_north(whole_map, ship_coordinates, ship_speed // 2 + ship_size)
        south_free = Algo.check_south(whole_map, ship_coordinates, ship_speed // 2 + ship_size)
